...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1d11b7264d774e65912c7f9b94cdb204) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "A simple library that allows to query a minecraft server (Status\nQuery Protocol).";
          description = None;
          categories = [];
               ...
               Library
                 ({
                   ...
                   },
                   {
                      lib_modules = ["Mcquery"];
                      lib_pack = false;
                      lib_internal_modules = ["Utils"; "Network"];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\252l[\221qc\225\226\\\131\"\180[<#6";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
